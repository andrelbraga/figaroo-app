...
export class myInit1622598533861 implements MigrationInterface {
    name = 'myInit1622598533861'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "public"."employer" ("employer_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "document" integer NOT NULL, "email" text NOT NULL, "birthdate" date NOT NULL, "name" text NOT NULL, "last_name" text, "password" text NOT NULL, "avatar_path" text, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(0), "updated_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_1f532bc38aa861e7b075bd8a45f" PRIMARY KEY ("employer_id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "employer_pkey" ON "public"."employer" ("employer_id") `);
        await queryRunner.query(`CREATE TABLE "public"."merchant" ("merchant_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "description" text, "employees" numeric(3,0), "document" numeric(20,0), "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(0), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "employer_id" uuid, "address_id" uuid, CONSTRAINT "PK_1ef35354c0a8756703335898101" PRIMARY KEY ("merchant_id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "merchant_pkey" ON "public"."merchant" ("merchant_id") `);
        await queryRunner.query(`CREATE TABLE "public"."address" ("address_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "street" text NOT NULL, "number" numeric(5,0) NOT NULL, "state" text NOT NULL, "country" text, "city" text NOT NULL, "zip" numeric(9,0) NOT NULL, "complement" text, "district" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(0), "updated_at" TIMESTAMP NOT NULL, "merchantsMerchantId" uuid, CONSTRAINT "PK_dda7b41112d4ec17c794a3da791" PRIMARY KEY ("address_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."merchant" ADD CONSTRAINT "FK_81a6b0633d14f2f158348083811" FOREIGN KEY ("address_id") REFERENCES "public"."address"("address_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "public"."address" ADD CONSTRAINT "FK_c4b9ca8765edb4675b424aa2cb3" FOREIGN KEY ("merchantsMerchantId") REFERENCES "public"."merchant"("merchant_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."address" DROP CONSTRAINT "FK_c4b9ca8765edb4675b424aa2cb3"`);
        await queryRunner.query(`ALTER TABLE "public"."merchant" DROP CONSTRAINT "FK_81a6b0633d14f2f158348083811"`);
