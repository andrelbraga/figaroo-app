...
export class myInit1632513758369 implements MigrationInterface {
    name = 'myInit1632513758369'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "public"."user" ("user_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" text NOT NULL, "phone" text NOT NULL, "document" text NOT NULL, "password" text NOT NULL, "status" text NOT NULL, "type" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(0), "updated_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_1252c2d719e83c1eec01d9128eb" PRIMARY KEY ("user_id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "user_pkey" ON "public"."user" ("user_id") `);
        await queryRunner.query(`CREATE TABLE "public"."customer" ("customer_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "last_name" text NOT NULL, "email" text NOT NULL, "phone" text NOT NULL, "document" text, "sur_name" text, "nationality" text, "avatar_path" text, "age" numeric, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" TIMESTAMP NOT NULL, "user_id" uuid, CONSTRAINT "REL_6e616b450261ea40f07d6f76e8" UNIQUE ("user_id"), CONSTRAINT "PK_dee6a0ab7759bbb03aca13915d3" PRIMARY KEY ("customer_id"))`);
