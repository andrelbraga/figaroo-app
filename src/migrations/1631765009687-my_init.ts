...
export class myInit1631765009687 implements MigrationInterface {
    name = 'myInit1631765009687'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "public"."user" ("user_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" text NOT NULL, "phone" text NOT NULL, "password" text NOT NULL, "status" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(0), "updated_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_1252c2d719e83c1eec01d9128eb" PRIMARY KEY ("user_id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "user_pkey" ON "public"."user" ("user_id") `);
        await queryRunner.query(`CREATE TABLE "public"."customer" ("customer_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "last_name" text NOT NULL, "email" text NOT NULL, "password" text NOT NULL, "phone" text NOT NULL, "document" text, "sur_name" text, "nationality" text, "avatar_path" text, "age" numeric, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" TIMESTAMP NOT NULL, "user_id" uuid, CONSTRAINT "REL_6e616b450261ea40f07d6f76e8" UNIQUE ("user_id"), CONSTRAINT "PK_dee6a0ab7759bbb03aca13915d3" PRIMARY KEY ("customer_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "public"."employe" ("employe_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "last_name" text NOT NULL, "email" text NOT NULL, "document" text NOT NULL, "nationality" text, "birthdate" date NOT NULL, "phone" text NOT NULL, "sur_name" text NOT NULL, "years_business" text NOT NULL, "password" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(0), "updated_at" TIMESTAMP NOT NULL, "age" text, "user_id" uuid, CONSTRAINT "REL_d187bc0661e15146b8b49ed4dd" UNIQUE ("user_id"), CONSTRAINT "PK_300c8e2db5c17e6b99c4689f301" PRIMARY KEY ("employe_id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "employe_pkey" ON "public"."employe" ("employe_id") `);
        await queryRunner.query(`CREATE TABLE "public"."employer" ("employer_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "document" text NOT NULL, "email" text NOT NULL, "birthdate" date NOT NULL, "name" text NOT NULL, "last_name" text, "password" text NOT NULL, "avatar_path" text, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(0), "updated_at" TIMESTAMP NOT NULL, "user_id" uuid, CONSTRAINT "REL_621a870fe34e48281fa666ceaf" UNIQUE ("user_id"), CONSTRAINT "PK_1f532bc38aa861e7b075bd8a45f" PRIMARY KEY ("employer_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."customer" ADD CONSTRAINT "FK_6e616b450261ea40f07d6f76e81" FOREIGN KEY ("user_id") REFERENCES "public"."user"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."employe" ADD CONSTRAINT "FK_d187bc0661e15146b8b49ed4ddd" FOREIGN KEY ("user_id") REFERENCES "public"."user"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "public"."employer" ADD CONSTRAINT "FK_621a870fe34e48281fa666ceafe" FOREIGN KEY ("user_id") REFERENCES "public"."user"("user_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."employer" DROP CONSTRAINT "FK_621a870fe34e48281fa666ceafe"`);
        await queryRunner.query(`ALTER TABLE "public"."employe" DROP CONSTRAINT "FK_d187bc0661e15146b8b49ed4ddd"`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."customer" DROP CONSTRAINT "FK_6e616b450261ea40f07d6f76e81"`);
